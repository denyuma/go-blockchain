...
func (bc *Blockchain) AddTransaction(sender string, recipient string, value float32, senderPublicKey *ecdsa.PublicKey, s *utils.Signature) bool {
	...
	if bc.VerifyTransactionSignature(senderPublicKey, s, t) {
		...
		log.Println("ERROR: Verify Transation")
	}
...
func NewTransaction(sendar string, recipient string, value float32) *Transaction {
	return &Transaction{senderBlockchainAddress: sendar, recipientBlockchainAddress: recipient, value: value}
}

...
func (tr *TransactionRequest) Valudate() bool {
	if tr.SenderBlockchainAddress == nil || tr.RecipientBlockchainAddress == nil || tr.SenderPrivateKey == nil || tr.SenderPublicKey == nil || tr.Value == nil {
		return false
	}
